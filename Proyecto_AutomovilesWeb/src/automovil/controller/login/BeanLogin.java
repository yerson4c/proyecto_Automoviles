...
import automovil.model.manager.LoginDTO;
import automovil.model.manager.ManagerLogin;
import automovil.model.manager.ManagerSeguridad;
		...
		try {
			if (!correo.isEmpty()&&!password.isEmpty()) {
				...
				//	managerAuditoria.crearEvento(correo, this.getClass(), "accederSistema", "Acceso a login");
					...
					JSFUtil.crearMensajeError("ERROR : Debe ingresar un correo v�lido");
				}
				
			}else {
				JSFUtil.crearMensajeError("ERROR : Debe ingresar su correo y contrase�a");
			}
