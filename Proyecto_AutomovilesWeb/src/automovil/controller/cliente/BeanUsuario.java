		...
		try {
			if (usuario.getCedulaUsuario().toString().length() > 0) {
				...
				if (lstUsuario.size()==0) {
					...
					JSFUtil.crearMensajeInfo("Usuario creado correctamente, por favor iniciar sesi�n");
					return "login";
				} else {
					...
					return "";
							...
							JSFUtil.crearMensajeError("Debe ingresar una c�dula v�lida");
							return "";
						}
					} else {
						JSFUtil.crearMensajeError("Debe ingresar un correo v�lido");
						return "";
					}
				} else {
				...
				JSFUtil.crearMensajeError("Debe ingresar la c�dula");
				return "";
